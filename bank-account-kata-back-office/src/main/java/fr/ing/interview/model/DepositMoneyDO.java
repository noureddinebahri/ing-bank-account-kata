...
@Entity
@Table(name = "DEPOSIT_MONEY")
public class DepositMoneyDO {
	...
	public DepositMoneyDO() {
	}

	public DepositMoneyDO(final long id, final double amount, final String currency, final AccountDO account, final String reference, final Date operationDate, final TransactionDO transaction) {
		this.id = id;
		this.amount = amount;
